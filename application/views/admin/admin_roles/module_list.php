				...
				<table id="example1" class="table table-bordered table-hover">
					<thead>
						<tr>
							...
							<th width="140"><?= trans('action') ?></th>
						</tr>
					</thead>
					<tbody>
						<?php foreach($records as $record): ?>
							<tr>
								<td width="10"><?= $record['module_id']; ?></td>
								...
								<td width="180" >
									...
									<a href="<?php echo site_url("admin/admin_roles/module_status/".$record['module_id']."/".$record['status']); ?>" class="btn btn-primary btn-xs mr5" >
									   <i class="fa fa-check" aria-hidden="true"></i>
									</a>
									<?php }else{?>
										<a href="<?php echo site_url("admin/admin_roles/module_status/".$record['module_id']."/".$record['status']); ?>" class="btn btn-secondary btn-xs mr5" >
									   <i class="fa fa-check" aria-hidden="true"></i>
									</a>
									<?php }?>
