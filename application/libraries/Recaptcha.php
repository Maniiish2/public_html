...
//    $config['recaptcha_site_key'] = '6LeQaXkaAAAAAIyWeV5eELvizVvW73KLMmUFBV7V';
  //  $config['recaptcha_secret_key'] = '6LeQaXkaAAAAAB1E1UpCTcIF-D9XqGSTu_-zUvVD';
    ...
    public function __construct()
    {
        ...
        $this->_siteKey   = '6LeQaXkaAAAAAIyWeV5eELvizVvW73KLMmUFBV7V';//$settings['recaptcha_site_key'];
        $this->_secretKey = '6LeQaXkaAAAAAB1E1UpCTcIF-D9XqGSTu_-zUvVD';//$settings['recaptcha_secret_key'];
